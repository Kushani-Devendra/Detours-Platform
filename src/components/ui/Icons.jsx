// Icon components — lightweight SVG icons matching the macOS aesthetic
...
export const Icons = {
  ...
  Clock: (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
